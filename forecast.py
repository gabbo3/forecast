...
class forecast():
    ...
    def __init__(self,df_diario : pd.DataFrame, df_mensual : pd.DataFrame,mes_anterior,model_path):
        self.model_path = model_path
        self.mes_anterior = mes_anterior
        self.session_diaria = df_diario
        self.session_mensual = df_mensual
...
def etl(session_diaria:pd.DataFrame, 
    ...
    print(f'Filter dataset by Origen != Otros')
...
def normalize_origen(x):
    ...
    # origens = ['La100','Mitre','Cienradios']
